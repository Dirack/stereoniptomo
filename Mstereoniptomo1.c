...
int main(int argc, char* argv[])
{
	...
	buildSlownessModelFromVelocityModel(n,o,d,sv,nsv,slow,nm);
	...
	for (q=0; q<nit; q++){
		...
		disturbParameters(temp,cnewv,sv,1.46,1.9,1);

		/* Function to update velocity model */
		buildSlownessModelFromVelocityModel(n,o,d,cnewv,nsv,slow,nm);
	...
	updateVelocityModel(n,o,d,otsv,nsv,slow,nm);
